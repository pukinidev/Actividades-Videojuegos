...
def create_enemy_entity(world: esper.World, enemy_type: str, position: pygame.Vector2, enemies_config: dict) -> int:
    ...
    return create_square(world, size, position, direction, color)
